...
{
    public class AnswerQuestionCommandHandler : IRequestHandler<AnswerQuestionCommand, ErrorOr<Guid>>
    {
        ...
        public AnswerQuestionCommandHandler(IValidator<CreateAnswerDto> validator, IGenericService<ForumAnswer> genericAnswerService, IQuestionService questionService, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<ErrorOr<Guid>> Handle(AnswerQuestionCommand request, CancellationToken cancellationToken)
        {
